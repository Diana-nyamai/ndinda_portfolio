  ...
  lists: [
    {
      ...
      name: "PinkPalace",
      description:
        "Pink Palace is a frontend project aimed at creating a website that provides information about a beautiful location where users can book photography grounds, host wedding parties, and celebrate birthdays.",
      technologies: [
        {
          name: "HTML",
          icon: html,
    ...
    },
    {
      ...
      description:
        "This is a web application developed utilizing Reactjs, and CSS to cater to individuals searching for romantic relationships, with a focus on those seeking a more targeted approach to finding compatible partners",
      technologies: [
        {
          name: "REACTJS",
          icon: react,
    ...
    },
    {
      ...
      description:
        "The Chat application is a web-based application that emulates the core features and functionality of the popular Social media application, Facebook.",
      technologies: [
        {
          name: "REACTJS",
          icon: react,
